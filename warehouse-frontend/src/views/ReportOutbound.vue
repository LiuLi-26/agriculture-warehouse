<template>
  <div class="report-container">
        ...
        <el-card class="stat-card" shadow="hover">
          <div class="stat-content">
            ...
            <div class="stat-info">
              ...
              <div class="stat-label">出库总数量(kg)</div>
            </div>
          </div>
        </el-card>
      </el-col>
        ...
        <el-card class="stat-card" shadow="hover">
          <div class="stat-content">
            ...
            <div class="stat-info">
              ...
              <div class="stat-label">出库总批次</div>
            </div>
          </div>
        </el-card>
      </el-col>
    ...
    <el-card class="table-card" shadow="hover">
      ...
      <el-table :data="outboundRecords" v-loading="loading" stripe>
...
const fetchStatistics = async () => {
  ...
  try {
    ...
    // 同时获取出库记录用于表格
    const records = await api.getOutboundRecords()
    ...
    outboundRecords.value = (records || []).map(record => ({
      ...record,
      productName: productMap.get(record.productId) || '未知'
    }))
